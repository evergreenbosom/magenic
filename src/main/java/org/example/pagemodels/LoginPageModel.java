...
public class LoginPageModel extends BaseSeleniumPageModel {
  ...
  private static final By ERRO_MES = By.cssSelector("#homeButton > a");
  private LazyWebElement Error = new LazyWebElement(this.getTestObject(), By.xpath("//*[@id=\"LoginError\"]"),
          "Lazyaboutele");
  ...
  public String LoginError () throws InterruptedException, TimeoutException, ExecutionFailedException {
    //UIWaitFactory.getWaitDriver(getWebDriver()).waitForClickableElement(About_Page).click();
    String ErrM = Error.getText();
